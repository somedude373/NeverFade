...
namespace Server.Items
{
	public static class TokenSystem
	{
		...
		{
			return MasterStorageUtils.GiveTypeToPlayer(player, typeof(NeverfadeTokens), amount, informPlayer);
		}
		...
		{
			return MasterStorageUtils.TakeTypeFromPlayer(player, typeof(NeverfadeTokens), amount, informPlayer);
		}
	}
	...
	public class NeverfadeTokens : Item
	{
		public NeverfadeTokens( int min, int max ) : this( Utility.Random( min, max-min ) )
		{
		}

		[Constructable]
		public NeverfadeTokens() : this( 1 )
		{
		}

		[Constructable]
		public NeverfadeTokens( int amount ) : base( 0xEED )
		{
			Stackable = true;
			Name = "Tokens";
			Hue = 1173;
		...
		public NeverfadeTokens( Serial serial ) : base( serial )
		{
		}
	...
	{ 
		...
		public static void RewardTokens(Mobile m, int amount)
		{
			if (amount < 1)
				return;
			MasterStorageUtils.GiveTypeToPlayer(m as PlayerMobile, typeof(NeverfadeTokens), amount, true);
		}
	}
}