...
namespace daat99
{
    public static class MasterStorageUtils
    {
...
#if USE_TOKENS
					currencyTypes.Add(typeof(NeverfadeTokens), typeof(NeverfadeTokens));
					currencyTypes.Add(typeof(TokenCheck), typeof(NeverfadeTokens));
#endif
				}
		...
		{
#if USE_TOKENS
			return GiveTypeToPlayer(player, typeof(NeverfadeTokens), amount, informPlayer);
#else
			return false;
#endif
		}
		...
		{
#if USE_TOKENS
			return TakeTypeFromPlayer(player, typeof(NeverfadeTokens), amount, informPlayer);
#else
			return false;
#endif
		}
